...
<font color=#003366 size=+2><b>Schedule</b></font>
...
<div class="sdate">Tuesday, June 7 (Mountain time)</div>
<div class="rowbreak" style="height: 20px"></div>

<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">09:00 – 09:15</div>
    </div>
    <div class="scolumn-66" style="background-color: #b2f4f0; padding-top:0">
        <div class="stitle">Opening remarks</div>
    </div> 
</div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">09:15 – 10:10</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 1 </div> 
        <div class="sstitle">Non-Fungible Tokens (NFTs): How Should the Apes Evolve?</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Ari Juels</div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">10:10 – 11:00</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 2 </div> 
        <div class="sstitle">How Dark is the Forest? On Blockchain Extractable Value and High-Frequency Trading in Decentralized Finance</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Arthur Gervais</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">11:00 – 11:10</div>
    </div>
    <div class="scolumn-66" style="background-color: #ECDACF; padding-top:0">
        <div class="stitle">Break</div>
    </div> 
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">11:10 – 12:10</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Sponsor talk</div>
        <div class="sstitle">Blockchain's Role in Alberta's Economic Future: a perspective</div>
        <div class="ssstitle">Speaker: Koleya Karringten</div>
        
        <div class="stitle">Invited talk 1</div>
        <div class="sstitle">How the standardization system can help advance blockchain in Canada</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Dominik Brejta</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
            <p> <b>Abstract: </b>Standardization is a useful tool that can help industry and government tackle a wide variety of problems. Standards and conformity assessments help foster collaboration, trade, and global connectivity, notably when they are developed by consensus and involve balanced stakeholder participation from industry, government, academia, and civil society. Several foundational standards have been published in the blockchain space, and others are in development, but there is much more work to be done.<br><br>
            
            In this talk, I will provide an overview of how the standardization system works, introduce some blockchain standards efforts, outline a roadmap for Canadian blockchain standards work, and share insights from stakeholders in the blockchain space to help address challenges and advance opportunities for Canada.</p>
            <p><b>Bio:</b> Dominik Brejta is a Sector Specialist at the Standards Council of Canada (SCC). In this role, he advises industry, academia, and government partners on navigating the standardization system and develop strategies to advance business and policy objectives. Dominik previously worked for a financial sector regulator and a financial services firm. He holds a bachelor’s degree in political science from the University of Ottawa and has completed the Canadian Securities Course as well as the Investment Advisor Training Program from the Canadian Securities Institute.</p>
        </div>
        <hr>
        
        <div class="stitle">Invited talk 2</div>
        <div class="sstitle">Breaking down data silos in supply chain</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Erik Valiquette</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
            <p> <b>Abstract: </b>Supply chains can be very complex but are still very linear. The industry has been doing business the same way for centuries using physical paperwork to exchange goods between trading partners. Global supply chains are getting ever more complex and in some cases critical to national security. This is why blockchain technology, in conjunction with other technologies or on its own, can play an important role in reshaping today’s supply chains by breaking down traditional data silos. </p>
                    <p><b>Bio:</b> Erik is the co-founder and CEO of the Blockchain Supply Chain Association. Through their core services of Advocacy, Collaboration and Education, they bring together like-minded professionals who want to explore Blockchain in their supply chain. The member-driven association's goal is to accelerate the adoption of Distributed Ledger Technology through dialog, to help shape policy with governmental agencies for improved services, and to help the community's voice to be heard. <br><br>With a 30 year career in logistics, he’s passionate about bridging the gap between technology and business needs and is a firm believer that Blockchain has the potential to bring global supply chain management to the next level by reducing inefficiencies. Erik is based in Montreal, Canada. </p>
        </div>
        <hr>
        
        <div class="stitle">Contributed talk 1</div>
        <div class="sstitle">Authenticating Data From the Statistics Canada Website </div> <div class="ssstitle">Lillian Klein, Didem Demirag and Kate Fedchun</div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">12:10 – 13:00</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 3 </div> 
        <div class="sstitle">Nec pluribus impar: An interface paradox</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Jason Teutsch</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="sdate">Wednesday, June 8 (Mountain time)</div>
<div class="rowbreak" style="height: 20px"></div>

<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">09:00 – 09:10</div>
    </div>
    <div class="scolumn-66" style="padding-top:0">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">09:10 – 10:00</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 4 </div> 
        <div class="sstitle" style="border-bottom: 0px">"Crypto Means Cryptography, Not Cryptocurrency:" A Misplaced Controversy</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Moti Yung</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">10:00 – 10:50</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 5 </div> 
        <div class="sstitle">Blockchain Consensus Protocols</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Christian Cachin</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">10:50 – 11:10</div>
    </div>
    <div class="scolumn-66" style="background-color: #ECDACF; padding-top:0">
        <div class="stitle">Break</div>
    </div> 
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">11:10 – 11:50</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Contributed talk 2</div>
        <div class="sstitle">From cryptocurrency acceptance to crypto-payment: An empirical investigation of why consumers may be reluctant</div> <div class="ssstitle">Mohamad Sadegh Sangari and Atefeh Mashatan</div>
        
        <div class="stitle">Contributed talk 3</div>
        <div class="sstitle">Citizen Science & OCAP - Using BCT to support cooperative management of resources across organizational borders</div> <div class="ssstitle">Ralph Deters</div> 
        
        <div class="stitle">Contributed talk 4</div>
        <div class="sstitle">Blockchain-enabled federated learning</div> <div class="ssstitle">Sara Rouhani</div> 
        <div class="stitle">Q/A Session</div> 
    </div> 
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">11:50 – 13:00</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Panel 1</div> <br>
        <div class="sstitle">Blockchain Education</div><br>
        <div class="ssstitle" style="border-bottom: 0px">Atefeh (Atty) Mashatan (Chair), Quinn DuPont, Marc Lijour, Sandra Ro, Tim Weing&auml;rtner, Victoria Lemieux</div>
        <button class="lm-button"><a href="panels.php#education">Learn More</a></button>
    </div> 
</div>
...
<div class="sdate">Thursday, June 9 (Mountain time)</div>
<div class="rowbreak" style="height: 20px"></div>
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 6 </div> 
        <div class="sstitle">Blockchains and the Future of Private Smart Contracts</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Andrew Miller</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Contributed talk 5</div>
        <div class="sstitle">Blockchain v. Censorship (or how blockchain and Streisand effect can make censorship accountable)</div> <div class="ssstitle">Swaminathan Ramesh and Ryan Henry</div> 
        
        <div class="stitle">Contributed talk 6</div>
        <div class="sstitle">One Bad Apple Spoils the Bunch: Transaction DoS in MimbleWimble Blockchains</div> <div class="ssstitle">Seyed Ali Tabatabaee, Charlene Nicer, Ivan Beschastnikh and Chen Feng</div> 
        
        <div class="stitle">Contributed talk 7</div>
        <div class="sstitle">Billions at Risk, Android Crypto Wallets are not Secure</div> <div class="ssstitle">Matthew Buhler and Shankar Ganesh</div> 
        
        <div class="stitle">Contributed talk 8</div>
        <div class="sstitle">User-controlled Offline Access for Anonymous Proof-of-Locations</div> <div class="ssstitle">Mamunur Rashid Akand, Sepideh Avizheh and Reihaneh Safavi-Naini</div> 
        <div class="stitle">Q/A Session</div> 
    </div>
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Panel 2</div> <br>
        <div class="sstitle">Blockchain in Future Networks</div><br>
        <div class="ssstitle" style="border-bottom: 0px">Doug Junor (Chair), Ben Smeets, Neel Dayal, Raouf Boutaba, Wen Tong</div>
        <button class="lm-button"><a href="panels.php#nft">Learn More</a></button>
    </div> 
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 7 </div> 
        <div class="sstitle">The Need for Blockchain-based Dynamic Consent in Healthcare</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Wendy Charles</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">13:00 – 13:30</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Contributed talk 9</div>
        <div class="sstitle">Blockchain, AI and Data Protection in Healthcare: A Comparative Analysis of Two Blockchain Data Marketplaces in relation to Fair Data Processing and the 'Data Double Spending' Problem</div> <div class="ssstitle">Deepansha Chhabra, Meng Kang and Victoria Lemieux</div>
        
        <div class="stitle">Contributed talk 10</div>
        <div class="sstitle">DeMed: A Novel and Efficient Decentralized Learning Framework for Medical Images Classification on Blockchain</div> <div class="ssstitle">Garima Aggarwal, Chun-Yin Huang, Xiaoxiao Li and Zehua Wang</div> 
        <div class="stitle">Q/A Session</div> 
    </div>
</div>
...
<div class="sdate">Friday, June 10 (Mountain time)</div>
<div class="rowbreak" style="height: 20px"></div>
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 8 </div> 
        <div class="sstitle">CBDC Developments and Hard Problems</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Dinesh Shah</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    ...
    <div class="scolumn-66">
        <div class="stitle">Keynote talk 9 </div> 
        <div class="sstitle">The Future of Privately-Held Money</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: Geoffrey Goodell</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">10:50 – 11:00</div>
    </div>
    <div class="scolumn-66" style="background-color: #ECDACF; padding-top:0">
        <div class="stitle">Break</div>
    </div> 
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">11:10 – 12:00</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Invited talk 3 </div> 
        <div class="sstitle">The Bahamian Sand Dollar: Lessons and Insights</div>
        <div class="ssstitle" style="border-bottom: 0px">Speaker: John Kim</div>
        <button class="collapsible-radius">Learn More</button>
        <div class="content1">
            <p> <b>Abstract: </b>Central Bank Digital Currency (CBDC) is fiat money in digital form. It is issued by the central bank or monetary authority of a country and is legal tender. It is not private money. The latest BIS survey indicates 90% of the world’s central banks and monetary authorities are at various stages of considering CBDCs. CBDC is quite literally the future of money. <br><br>The award-winning "Sand Dollar" issued by the Central Bank of the Bahamas is one of a small handful of live, full-scale CBDC productions in the world. It is also the most stable and most mature, having had a two-year head start. As such, it provides interesting insights and lessons regarding CBDCs and their deployment and use. As a Co-Founder of the company that helped create the Sand Dollar, I will provide a closer look behind the scenes into Sand Dollar and share some of our experiences working with a live CBDC deployment. </p>
                    <p><b>Bio:</b> John Kim is a corporate lawyer with two decades of experience in M&A, securities, fintech and digital technologies. He was a partner at the global law firm of Norton Rose Fulbright LLP and the Canadian Lead Partner of the firm’s Global Fintech Group. He is a co-founder of Movmint.io which builds regulated digital currency systems around the world. <br><br>John is considered a leading legal expert on topics concerning the application of distributed ledger technology, digital currencies and digital assets. He led the team that won the prestigious Central Banking Publications - Advisor of the Year Award for Fintech and Digital Projects in 2020.  John consults for central banks, leading financial firms, regulators and academic institutions. He helped launch the world’s first retail Central Bank Digital Currency (CBDC) in production - the Sand Dollar in The Bahamas. John also teaches at the Allard School of Law at the University of British Columbia (UBC).
 </p>
        </div><hr>
        
        <div class="stitle">Contributed talk 11</div>
        <div class="sstitle">Systemic Fragility in Decentralized Markets</div> <div class="ssstitle">Alfred Lehar and Christine Parlour</div> 
        
        <div class="stitle">Contributed talk 12</div>
        <div class="sstitle">Immutability vs. Upgradeability in Ethereum: Myth vs. Reality</div> <div class="ssstitle">Mehdi Salehi, Jeremy Clark and Mohammad Mannan</div> 
        
        <div class="stitle">Contributed talk 13</div>
        <div class="sstitle">Smart Contracts' Governance: A New Order for Economic Activity?</div> <div class="ssstitle">Iris Wang and Jan Bena</div> 
        <div class="stitle">Q/A Session</div> 
    </div>
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">12:00 – 13:10</div>
    </div>
    <div class="scolumn-66">
        <div class="stitle">Panel 3</div> <br>
        <div class="sstitle">Blockchain Culture, Leisure and Luxury</div><br>
        <div class="ssstitle" style="border-bottom: 0px">Jeremy Clark (Chair), Blake Finucane, Tamara Goddard, Will Robinson</div>
        <button class="lm-button"><a href="panels.php#culture">Learn More</a></button>
    </div> 
</div>
<div class="rowbreak"></div>
...
<div class="col-container">
    <div class="scolumn-33">
        <div class="stime">13:10 – 13:30</div>
    </div>
    <div class="scolumn-66" style="background-color: #b2f4f0; padding-top:0">
        <div class="stitle">Closing remarks</div>
    </div> 
</div>
